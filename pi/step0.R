### R code from vignette source '/localhome/ifsv/zpt949/Documents/wip/lasso/interactions/PI/step0'
### Encoding: UTF-8

###################################################
### code chunk number 1: Stangle (eval = FALSE)
###################################################
## #setwd("/home/ann-sophie/Documents/wip/lasso/interactions/PI/")
## setwd("/run/user/551438008/gvfs/smb-share:domain=SUND,server=sund.root.ku.dk,share=users,user=zpt949/LINUX/ifsv/zpt949/Documents/wip/lasso/interactions/PI")
## #setwd("/localhome/ifsv/zpt949/Documents/wip/lasso/interactions/PI")
## Stangle("/localhome/ifsv/zpt949/Documents/wip/lasso/interactions/PI/step0")
## #Stangle("/run/user/551438008/gvfs/smb-share:domain=SUND,server=sund.root.ku.dk,share=users,user=zpt949/LINUX/ifsv/zpt949/Documents/wip/lasso/interactions/PI/step0")
## #Stangle("/home/ifsv/zpt949/Documents/wip/lasso/interactions/PI/step0")
## #Stangle("/home/ann-sophie/Documents/wip/lasso/interactions/PI/step0")
## #Stangle("step0")
...
###################################################
### code chunk number 5: step0.Rnw:212-392
###################################################
...
###################################################
### code chunk number 6: step0.Rnw:395-396
###################################################
W <- 10


###################################################
### code chunk number 7: step0.Rnw:399-417
###################################################
#############################
