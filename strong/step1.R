### R code from vignette source '/localhome/ifsv/zpt949/Documents/wip/lasso/interactions/Strong/step1'
### Encoding: UTF-8
...
## Stangle("/localhome/ifsv/zpt949/Documents/wip/lasso/interactions/Strong/step1")
## #Stangle("/run/user/551438008/gvfs/smb-share:domain=SUND,server=sund.root.ku.dk,share=users,user=zpt949/LINUX/ifsv/zpt949/Documents/wip/lasso/interactions/Strong/step1")
## #Stangle("/home/ifsv/zpt949/Documents/wip/lasso/interactions/Strong/step1")
## #Stangle("/home/ann-sophie/Documents/wip/lasso/interactions/Strong/step1")
## #Stangle("step1")
